...
| 침입 대응 | <ul><li>식별된 취약점에 대한 정보 제공 및 전파</li><li>침해사고 발생 시 전파 및 n/w 레벨의 침해 경로, 취약점 정보 제공</li><li>침해사고 발생시 패킷 덤프 등 후속 대응 업무를 수행하여 사고분석 지원<li>침해사고 발생시 명백한 침해로 확인된 경우 침해시도 IP 선차단 수행</li></ul> |
