...
## Security > Security Monitoring > 콘솔 사용 가이드 { #security-security-monitoring-console-guide }
...
## 보안관제 서비스 신청 및 해제 { #service-application-and-release }
<a id="add-security-monitoring-targets"></a>
### 보안관제 대상 추가 { #add-security-monitoring-targets }
...
### 보안관제 대상 해제 { #release-from-security-monitoring }
...
## 보안관제 업무 수신 설정 { #receiving-information-for-security-monitoring-events }
...
### 긴급 건 유선 연락 허용 { #enable-phone-communication-for-urgency }
...
### 업무 처리 내역 메일 수신 신청 { #apply-for-mail-notification-on-progress }
...
## 보안관제 현황 확인 { #check-security-monitoring-status }
...
## 상세 이벤트 현황 확인 { #check-detailed-event-status }
