...
## Security > Security Monitoring > 개요 { #security-security-monitoring-overview }
...
<a id="benefits"></a>
## Security Monitoring 특장점 { #benefits }

<a id="security-monitoring-by-controlled-security-center"></a>
### 통제된 보안관제센터에서 보안관제 서비스를 제공합니다. { #security-monitoring-by-controlled-security-center }
...
### 24시간 365일 전문 인력의 보안관제 분석 및 운영 서비스를 제공하며 비용 절감 효과가 있습니다. { #247-cost-efficient-professional-monitoring-and-operation-services }
...
### 파견 관제 업무 수준에 준한 차별화된 차세대 원격 보안관제 서비스를 제공합니다. { #distinctive-next-generation-remote-security-service }
...
### 보안관제 업무 처리 수행 내역을 콘솔에서 실시간으로 확인할 수 있습니다. { #real-time-security-monitoring-checks-on-console }
...
## Security Monitoring 주요 기능 { #main-features }
