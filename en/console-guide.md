...
## Security > Security Monitoring > Console Guide { #security-security-monitoring-console-guide }
...
## Service Application and Release { #service-application-and-release }
<a id="add-security-monitoring-targets"></a>
### Add Security Monitoring Targets { #add-security-monitoring-targets }
...
###  Release from Security Monitoring { #release-from-security-monitoring }
...
## Receiving Information for Security Monitoring Events { #receiving-information-for-security-monitoring-events }
...
### Enable Phone Communication for Urgency { #enable-phone-communication-for-urgency }
...
### Apply for Mail Notification on Progress { #apply-for-mail-notification-on-progress }
...
## Check Security Monitoring Status { #check-security-monitoring-status }
...
## Check detailed event status { #check-detailed-event-status }
